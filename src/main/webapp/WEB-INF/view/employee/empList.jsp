								...
								<div class="col-lg-12">
									<div class="card">
										<div class="card-header">
											<h5 class="card-header">Emp List</h5>
										</div>
										<div class="card-body">
											<div align="right">
												<a href="${pageContext.request.contextPath}/employee/addEmp" class="btn rounded-pill me-2 btn-primary" style="color: white;"><i class="menu-icon tf-icons bx bx-plus"></i>ADD</a>
											</div>
												...
												<table class="table text-center">
													...
													<tbody class="table-border-bottom-0">
														<c:forEach var="e" items="${list}">
															<tr>
																<td style="width: 500px;">${e.empId}</td>
																<td style="width: 200px;">${e.empName}</td>
																<td style="width: 200px;">
																	<a href="${pageContext.request.contextPath}/employee/removeEmp?empNo=${e.empNo}"><i class='bx bxs-trash'></i></a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
												...
												<div>
													<nav aria-label="Page navigation">
														<ul class="pagination justify-content-center">
															...
															<c:if test="${currentPage != 1}">
																<li class="page-item prev">
																	<a class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=1&searchWord=${searchWord}"><i class="tf-icon bx bx-chevrons-left"></i></a>
																</li>
															</c:if>
															...
															<c:forEach var="e" begin="${startPage}" end="${endPage}" step="1">
																<li class="page-item">
																	<a class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${e}&searchWord=${searchWord}">${e}</a>	
																</li>
															</c:forEach>
															...
															<c:if test="${currentPage != lastPage}">
																<li class="page-item next">
																	<a class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${lastPage}&searchWord=${searchWord}"><i class="tf-icon bx bx-chevrons-right"></i></a>
																</li>	
															</c:if>
														</ul>
													</nav>
