												...
												<table class="table text-center">
													...
													<tbody class="table-border-bottom-0">
														<c:forEach var="n" items="${notQueList}">
															<tr>
																<td style="width: 700px;"><a href="${pageContext.request.contextPath}/teacher/test/addQuestion?testNo=${n.testNo}">${n.testTitle}</a></td>
																<td style="width: 400px;">${n.createdate}</td>
																<td style="width: 200px;">
																	<a href="${pageContext.request.contextPath}/teacher/test/removeTest?testNo=${n.testNo}"><i class='bx bxs-trash'></i></a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
												...
												<div>
													<nav aria-label="Page navigation">
														<ul class="pagination justify-content-center">
															...
															<c:if test="${currentPage != 1}">
																<li class="page-item prev">
																	<a class="page-link" href="${pageContext.request.contextPath}/teacher/test/notQueTestList?currentPage=1&searchWord=${searchWord}"><i class="tf-icon bx bx-chevrons-left"></i></a>
																</li>
															</c:if>
															...
															<c:if test="${prev == true}">
																<li class="page-item prev">
																	<a class="page-link" href="${pageContext.request.contextPath}/teacher/test/notQueTestList?currentPage=${currentPage - 1}&searchWord=${searchWord}"><i class="tf-icon bx bx-chevron-left"></i></a>
																</li>
															</c:if>
															
															<c:forEach var="e" begin="${startPage}" end="${endPage}" step="1">
																<li class="page-item">
																	<a class="page-link" href="${pageContext.request.contextPath}/teacher/test/notQueTestList?currentPage=${e}&searchWord=${searchWord}">${e}</a>	
																</li>
															</c:forEach>
															...
															<c:if test="${next == true}">
																<li class="page-item next">
																	<a class="page-link" href="${pageContext.request.contextPath}/teacher/test/notQueTestList?currentPage=${currentPage + 1}&searchWord=${searchWord}">
															...
															<c:if test="${currentPage != lastPage}">
																<li class="page-item next">
																	<a class="page-link" href="${pageContext.request.contextPath}/teacher/test/notQueTestList?currentPage=${lastPage}&searchWord=${searchWord}"><i class="tf-icon bx bx-chevrons-right"></i></a>
																</li>	
															</c:if>
														</ul>
													</nav>
