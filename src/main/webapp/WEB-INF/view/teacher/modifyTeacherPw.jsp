					...
					<div class="card">
						<div class="card-body">
							<div class="app-brand justify-content-center">
								<span class="app-brand-text demo text-body fw-bolder">${loginTeacher.teacherName}</span>
							</div>
							<!-- /Logo -->
							<h4 class="mb-2">Change Password 🔒</h4>
							<form class="mb-3" method="post" action="${pageContext.request.contextPath}/teacher/modifyTeacherPw">
								<div class="mb-3">
